...
public class Main {
  public static void main(String[] args) {
    ...
    ContaPoupanca cp2 = new ContaPoupanca(13, LocalDate.now(), ct2, 4.0, LocalDate.of(1980, 6, 29));
    ContaPoupanca cp3 = new ContaPoupanca(14, LocalDate.now(), ct2, 11.0, LocalDate.of(1980, 6, 29));
    ...
    for(Conta c : ct1.getContas()){
      ...
      System.out.println("Tarifa: " + c.calcularTarifa());
      System.out.println("---------------------------------");
    }
    System.out.println("Total da Tarifa: " + ct1.totalTarifas());
    ...
    System.out.println("Total da Tarifa: " + ct2.totalTarifas());
